    ...
    <>
      ...
      <Offcanvas show={show} onHide={handleClose}>
        <Offcanvas.Header closeButton>
          <Offcanvas.Title className="displayfont">How to...</Offcanvas.Title>
        </Offcanvas.Header>
        <Offcanvas.Body className="text-black bg-transparent">
          <h5 className="displayfont display-6">...interact with the app</h5>
          ...
          <h5 className="displayfont display-6">...read the cards</h5>
          ...
          <h5 className="displayfont display-6">...read the spread</h5>
